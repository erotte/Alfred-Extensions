...
if [ "$1" != "nocache" ] && [ $(stat -f "%m" ~/Library/Caches/com.runningwithcrayons.Alfred-3/Workflow\ Data/dk.aiyo.SendURL/url) -ge $TIME ]
    then
    touch ~/Library/Caches/com.runningwithcrayons.Alfred-3/Workflow\ Data/dk.aiyo.SendURL/url
    head -1 ~/Library/Caches/com.runningwithcrayons.Alfred-3/Workflow\ Data/dk.aiyo.SendURL/url
else
# no cache, fetch url from frontmost browser
    ...
    # cache the url
    if [ ! -d ~/Library/Caches/com.runningwithcrayons.Alfred-3/Workflow\ Data/dk.aiyo.SendURL/ ]
        then
        mkdir ~/Library/Caches/com.runningwithcrayons.Alfred-3/Workflow\ Data/dk.aiyo.SendURL
    fi
    echo $THEURL > ~/Library/Caches/com.runningwithcrayons.Alfred-3/Workflow\ Data/dk.aiyo.SendURL/url
    # return the url
    echo $THEURL
fi
